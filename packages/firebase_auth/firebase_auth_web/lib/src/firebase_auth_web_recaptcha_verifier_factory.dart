...
class RecaptchaVerifierFactoryWeb extends RecaptchaVerifierFactoryPlatform {
  ...
  RecaptchaVerifierFactoryWeb({
    ...
    if (container == null || container.isEmpty) {
      ...
      html.Element? el = html.window.document.getElementById(_kInvisibleElementId);
      ...
      html.window.document.documentElement!.appendChild(html.createElementTag('div')..id = _kInvisibleElementId);
      ...
      assert(
        html.window.document.getElementById(container) != null,
  ...
  void clear() {
    _delegate.clear();
    html.window.document.getElementById(_kInvisibleElementId)?.remove();
  }
